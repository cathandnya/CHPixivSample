...
{
	[[CHPixivService sharedInstance] loadAccount];
	...
	PixivMenuViewController *menu = [[[PixivMenuViewController alloc] initWithStyle:UITableViewStyleGrouped] autorelease];
	UINavigationController *menuNav = [[[UINavigationController alloc] initWithRootViewController:menu] autorelease];
	self.window.rootViewController = menuNav;
	
	if (![CHPixivService sharedInstance].available) {
